...
bool Bar2Object::Initialize()
{
	...
	m_pBarTexture->SetTextureAsset(L"../Resource/graph_blue.png", L"");
	...
	m_pBarFlagTexture->SetTextureAsset(L"../Resource/graph_flag_blue.png", L"");
...
void Bar2Object::Update(const float deltaTime)
{
	// µ·¹¶Ä¡ ¸î°³ ³Ö¾ú´ÂÁö
	int countMoney = 0;
