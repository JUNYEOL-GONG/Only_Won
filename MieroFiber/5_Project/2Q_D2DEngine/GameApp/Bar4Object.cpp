...
bool Bar4Object::Initialize()
{
	...
	m_pBarTexture->SetTextureAsset(L"../Resource/graph_green.png", L"");
	...
	m_pBarFlagTexture->SetTextureAsset(L"../Resource/graph_flag_green.png", L"");
...
void Bar4Object::Update(const float deltaTime)
{
	// µ·¹¶Ä¡ ¸î°³ ³Ö¾ú´ÂÁö
	int countMoney = 0;
