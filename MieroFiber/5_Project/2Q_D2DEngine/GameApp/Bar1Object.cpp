...
bool Bar1Object::Initialize()
{
	...
	m_pBarTexture->SetTextureAsset(L"../Resource/graph_red.png", L"");
	...
	m_pBarFlagTexture->SetTextureAsset(L"../Resource/graph_flag_red.png", L"");
...
void Bar1Object::Update(const float deltaTime)
{
	// µ·¹¶Ä¡ ¸î°³ ³Ö¾ú´ÂÁö
	int countMoney = 0;
