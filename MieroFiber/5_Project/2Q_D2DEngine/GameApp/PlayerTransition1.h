...
class IdleToMove1 : public PlayerTransition1
{
public:
...
class MoveToIdle1 : public PlayerTransition1
{
public:
	std::pair<std::wstring, framework::Vector2D> operator()() final
	{
...
class StateToStun1 : public PlayerTransition1
{
	std::pair<std::wstring, framework::Vector2D> operator()() final
	{
		if (m_HP > 0)
...
class StunToIdle1 : public PlayerTransition1
{
	std::pair<std::wstring, framework::Vector2D> operator()() final
	{
		if (m_HP > 0)
