...
class IdleToMove4 : public PlayerTransition4
{
public:
...
class MoveToIdle4 : public PlayerTransition4
{
public:
	std::pair<std::wstring, framework::Vector2D> operator()() final
	{
...
class StateToStun4 : public PlayerTransition4
{
	std::pair<std::wstring, framework::Vector2D> operator()() final
	{
		if (m_HP > 0)
...
class StunToIdle4 : public PlayerTransition4
{
	std::pair<std::wstring, framework::Vector2D> operator()() final
	{
		if (m_HP > 0)
